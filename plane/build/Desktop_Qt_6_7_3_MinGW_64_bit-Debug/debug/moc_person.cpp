...
Q_CONSTINIT const QMetaObject Person::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSPersonENDCLASS_t,
        ...
        // method 'forgetpasswordClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'homeButtonclicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_MyButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_secureButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Person::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->forgetpasswordClicked(); break;
        case 2: _t->homeButtonclicked(); break;
        case 3: _t->on_MyButton_clicked(); break;
        case 4: _t->on_secureButton_clicked(); break;
        case 5: _t->on_logoutButton_clicked(); break;
        case 6: _t->on_changepasswordButton_clicked(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Person::logoutClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Person::*)();
            if (_t _q_method = &Person::forgetpasswordClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Person::*)();
            if (_t _q_method = &Person::homeButtonclicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Person::logoutClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Person::forgetpasswordClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void Person::homeButtonclicked()
{
